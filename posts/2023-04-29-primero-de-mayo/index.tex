...
\title{Significado histórico del Primero de Mayo}


\shorttitle{Significado histórico del Primero de Mayo}
...
\hypersetup{
  pdftitle={Significado hist\'{o}rico del Primero de Mayo},
  pdfauthor={Autor}
}
\makeatletter
...
\tableofcontents
\newpage
\section[Introduction]{Significado histórico del Primero de Mayo}
