...
\title{Análisis crítico del capitalismo actual}


\shorttitle{Análisis crítico del capitalismo actual}
...
\hypersetup{
  pdftitle={An\'{a}lisis cr\'{\i}tico del capitalismo actual},
  pdfauthor={Autor}
}
\makeatletter
...
\tableofcontents
\newpage
\section[Introduction]{Análisis crítico del capitalismo actual}
